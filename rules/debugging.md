...
- No scope expansion beyond `docs/prd.md` without updating docs or creating an issue.
...
- See `skills/tdd/tests-flutter.md` for widget test patterns.

## During dev

If the bug reveals missing acceptance criteria, update **`docs/manual_qa_*.md`** or the GitHub issue — not ad-hoc fixes only.
