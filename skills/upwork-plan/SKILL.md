...
description: >
  ...
  Trigger on: "/upwork-plan", "create a plan for this brief", "analyze this upwork brief",
...
Append to `%USERPROFILE%\.claude\skills\upwork-plan\feedback.jsonl` (Windows) or `~/.claude/skills/upwork-plan/feedback.jsonl` (macOS):
```json
