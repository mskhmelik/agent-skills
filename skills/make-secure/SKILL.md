...
**User skills:**
List directories under `%USERPROFILE%\.claude\skills\` and read each `<dir>\SKILL.md`.

**Plugin skills:**
Read `%USERPROFILE%\.claude\plugins\installed_plugins.json`. For each entry's `installPath`, glob `<installPath>\skills\**\SKILL.md`.
