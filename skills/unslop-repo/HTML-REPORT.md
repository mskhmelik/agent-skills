...
The diagrams carry the weight. Prose is sparse, plain, and uses the glossary terms ([LANGUAGE.md](LANGUAGE.md)) without ceremony. **Domain module names** come from **`docs/CONTEXT.md`**.
...
Architectural nouns and verbs from [LANGUAGE.md](LANGUAGE.md). Domain nouns from **`docs/CONTEXT.md`**.
